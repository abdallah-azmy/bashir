...
import 'package:bashir/src/UI/SupScreens/News/addComment.dart';
import 'package:bashir/src/UI/SupScreens/News/newsPhotoGallary.dart';
import 'package:bashir/src/models/getNewsById.dart';
...
class _NotificationDetailsState extends State<NotificationDetails> {
  ...
  Future<void> _createDynamicLink() async {
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      ...
      link: Uri.parse('https://bashir.page.link?id=${widget.id}'),
